...
export function Admin() {
  ...
  return (
    <>
      ...
      <div className="saringan" style={{ marginTop: 16 }}>
        {TAB.map((t) => (
    ...
    <>
      <section className="kartu">
        ...
        <p className="petunjuk">
          ...
          yang menghentikan lima ejaan untuk satu instansi berkembang jadi delapan.
        </p>
        <div className="tabel-bungkus">
          <table>
  ...
  return (
    <>
      ...
      <section className="kartu">
        ...
        <label>Kata sandi<input type="password" value={sandi} onChange={(e) => setSandi(e.target.value)} />
      ...
      <section className="kartu">
        ...
        <label>Kata sandi lama<input type="password" value={lama} onChange={(e) => setLama(e.target.value)} /></label>
        <label>Kata sandi baru<input type="password" value={baru} onChange={(e) => setBaru(e.target.value)} /></label>
        <div className="tombol-baris">
          <button className="tombol tombol-utama" onClick={async () => {
