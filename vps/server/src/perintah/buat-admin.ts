/**
 * perintah/buat-admin.ts - buat akun admin dari baris perintah.
 *
 *   node dist/perintah/buat-admin.js <email> <nama> <sandi>
 *
...
async function utama(): Promise<void> {
  ...
  if (!email || !sandi) {
    console.error('Pemakaian: node dist/perintah/buat-admin.js <email> <nama> <sandi>');
    process.exitCode = 1;
    return;
  }
