/**
 * rute/admin.ts - dashboard Bagian Hukum.
 *
...
import { wajibAdmin, bacaSesi } from '../tengah/auth.js';
...
import { opdSemua, opdTambah, opdNonaktifkan } from '../repo/opd.js';
import { pengaturanSemua, pengaturanSetel, BATAS_MAKS_MB } from '../repo/pengaturan.js';
import { logTerakhir, logCatat } from '../repo/log.js';
import { rekapPerStatus, rekapPerOpd, rekapPerBulan, rataLamaProsesHari, cariMandek } from '../murni/rekap.js';
import { TAHAP_RIWAYAT, STATUS_PENGAJUAN } from '../murni/skema.js';
import { migrasiPeriksa, migrasiJalankan } from '../layanan/migrasi.js';
