...
import { migrasiJalankan, migrasiPeriksa, tanggalDariTimestamp, normalisasiBanding } from '../layanan/migrasi.js';
...
const CSV = [
  ...
  '"02/05/2026 10:00:00","Bapperida","Daerah","Raperda tentang Retribusi",' +
...
describe('migrasiJalankan', () => {
  ...
  it('OPD yang tidak dikenali dilaporkan, bukan ditebak diam-diam', async () => {
    const l = await migrasiJalankan(OPSI);
    expect(l.opdPerluPeriksa).toContain('Bapperida');
  });
